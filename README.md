...
<img src="assets/regua-simbolo.png" alt="RÉGUA" width="120" />
...
## O diferencial: a simulação que faz o cliente dizer *sim*
...
<img src="img/landing-mobile.png" alt="RÉGUA: simulação de corte e cor, recursos e planos" width="300" />
...
|---|---|
| **Agenda + WhatsApp** | Horários do dia e confirmação por WhatsApp num toque: menos no-show, menos cadeira vazia. |
| **Clientes e ficha** | Histórico de corte, cor, observações e o antes/depois de cada atendimento. |
...
| **Clube de assinatura** | Plano mensal pros clientes fiéis. Receita recorrente, previsível, todo mês. |
| **Simulação de corte/cor** | O try-on on-device que **só o RÉGUA tem**: o motivo de o cliente fechar o combo. |
| **Link de agendamento** | Página pública da sua barbearia: o cliente pede horário, você confirma. |
...
### [Começar o teste grátis em regua.web.app](https://regua.web.app)
...
<img src="img/landing-desktop.png" alt="RÉGUA: página do produto" width="720" />

<br/><br/>

<img src="img/agendamento.png" alt="RÉGUA: agendamento online confirmado pelo cliente" width="260" />
...
<img src="assets/brand-sheet.png" alt="RÉGUA: brand sheet" width="760" />
...
<img src="https://paulocodex.com/brand/ninjas/regua.png" alt="NaRégua: ninja" width="200" align="right" />

Todo projeto do estúdio tem o **ninja Codex** na cor da sua identidade: o mesmo mascote da casa, recolorido pro tema do **NaRégua**.
